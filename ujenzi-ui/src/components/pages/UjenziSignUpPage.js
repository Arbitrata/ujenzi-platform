    ...
    return (
      <div className="w-[100vw] h-[800px] mx-w-[1428px] mx-h-[1117] flex">
        <div className="w-[47%] h-[100%] bg-ujenzi-white pl-[70px] block pt-4">
          <UjenziLogo />
          <div className="w-[490px] h-[550px] shadow mt-[50px] shadow-ujenzi-darkgray relative grid place-items-center">
            <img
        ...
        <div className="w-[53%] h-[100%] bg-ujenzi-lightgreen pt-4 pr-[70px]">
          ...
          <form
            ...
            className="w-[550px] h-[90%] block pt-[30px] pl-[80px]"
          >
            ...
            {this.renderSelect("userlocation", "Location", " ", "w-[550px]")}
            <div className="flex grid-cols-2 gap-3">
              {this.renderInput("password", "Password", "password", "w-[270px]")}
              {this.renderInput(
                "confirmpassword",
                "Confirm Password",
                "password",
            ...
            <div className="flex grid-cols-2 gap-3 w-[550px] justify-between pt-4">
              <Link to={"/"}>
                <UjenziButton
                  buttonStyle={
                    "bg-[#FFFFFF] hover:text-[#FFFFFF] hover:bg-ujenzi-blue text-ujenzi-blue "
